...
def main():
    ap = argparse.ArgumentParser(description="Train ResNet-152 on CIFAR-100 from random initialization")
    ...
    if args.exp is None:
        args.exp = f"resnet152_random_{args.freeze_mode}_cifar100"
